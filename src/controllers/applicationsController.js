...
const submitApplication = async (req, res) => {
  try {
    const {
      ...
      current_position, experience_years, current_employer,
    ...
    const result = await query(
      ...
      [
        ...
        current_position || null, experience_years || null, current_employer || null,
  ...
  try {
    ...
    const result = await query(
      `SELECT
         ...
         a.current_position, a.experience_years, a.current_employer,
